...
export const productEntityTypes = ['MASTER_PRODUCTS_V1', 'PRODUCT_ACCESS_CODES_V1', 'FAMILY_DIVISION_CATEGORY_V1', 'FAMILY_TAX_PROFILE_V1', 'TAXATION_UF_V1', 'FAMILY_UF_DEFAULT_RATE_V1', 'FAMILY_PACKAGING_V1', 'FAMILY_SUPPLIERS_V1', 'FISCAL_DOCUMENT_ITEMS_V1', 'CGO_CFOP_RULES_V1'] as const;
