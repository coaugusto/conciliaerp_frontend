...
export type TaxationProfile = { id: string; companyState: string; counterpartyState: string; taxationType: string | null; taxRegimeId: string | null; cstIcms: string | null; cstPis: string | null; cstCofins: string | null; cstIpi: string | null; cfop: string | null; icmsRate: string | number | null; icmsStRate: string | number | null; icmsStMvaPct: string | number | null; fcpRate: string | number | null; difalRate: string | number | null; linkSource: "FROM_CADASTRO" | "REUSED_EXISTING" | "MANUAL" };
